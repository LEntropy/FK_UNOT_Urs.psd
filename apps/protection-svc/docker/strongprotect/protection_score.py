...
@torch.no_grad()
def _generate_and_score_sd15(attacker, lora_unet, text_embeddings, true_image, model, processor, num_samples, gen_seed):
...
@torch.no_grad()
def _generate_and_score_sdxl(branch, lora_unet, cond, true_image, model, processor, size, num_samples, gen_seed):
    from diffusers import DDIMScheduler

"""Scores the full Anti-DreamBooth (ASPL) attack's real LoRA-validation
...
convention experiments/diffusion_attack_validation/generate_and_score.py
already uses), scoped to this experiment's own attacked_v1.safetensors
output naming.
...
def main() -> None:
    ...
    print()
    print("=== per-run results (full Anti-DreamBooth / ASPL attack) ===")

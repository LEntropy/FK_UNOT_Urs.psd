"""Scores the hybrid ensemble cloak's real LoRA-validation experiment --
same CLIP-similarity method and verdict logic as
...
convention experiments/diffusion_attack_validation/ and
experiments/aspl_validation/ already use), scoped to this experiment's own
attacked_v1.safetensors output naming.
...
def main() -> None:
    ...
    print()
    print("=== per-run results (hybrid ensemble cloak: style + concept + ASPL denoise) ===")
    ...
    print("compare to aspl_attack (surrogate-retrain denoising loss, n=10): mean delta +0.0050 (95% CI [-0.0094, +0.0195])")
